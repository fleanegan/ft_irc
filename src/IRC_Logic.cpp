...
bool IRC_Logic::appendMatchingSingleRecipients(const IRC_User &user, std::queue<int> *recipients,
...
bool IRC_Logic::isValidRecipientMask(const IRC_User &user, const std::string &target) {
    ...
    bool multiWildAfterLastPoint =
            lastMultiWildcardPosition != std::string::npos && lastMultiWildcardPosition > lastPointPosition;
    bool singleWildAfterLastPoint =
            lastSingleWildcardPosition != std::string::npos && lastSingleWildcardPosition > lastPointPosition;
